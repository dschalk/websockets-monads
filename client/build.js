  ...
  mM19.bnd(function () {
    return mM3.bnd(toFloat).bnd(function () {
      return mM7.fmap(function () {
        ...
        return mM1.bnd(push, mM7.x).bnd(clean).bnd(next, mM7.x == 18, mMI4).bnd(next, mM7.x == 20, mMI2);
